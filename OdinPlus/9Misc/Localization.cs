...
{"op_munin_notask","You don't have any quests"},
{"op_munin_notenough","Not enough... find more!"},
{"op_munin_takeoffer","Nice!"},
{"op_munin_task_lvl","Current Quest Level:"},
{"op_munin_taskfull","You have too many quests, try to clear some before you add more"},
...
{"op_task_treasure_target_pr_1","Looks like you are close to the chest,look around find a "},
{"op_task_treasure_target_po_1"," ..."},
{"op_task_treasure_start_pr_1","There is a "},
{"op_task_treasure_start_po_1"," near the location i marked for you,check your map ..."},
{"op_task_hunt_target_pr_1","Looks like you are close to the "},
{"op_task_hunt_target_po_1"," Watchout!"},
{"op_task_hunt_start_pr_1","There is a "},
{"op_task_hunt_start_po_1"," near the location i marked for you,check your map ..."},
{"op_task_dungeon_target_pr_1","Looks like you are close to the dungeon,look around find a "},
{"op_task_dungeon_target_po_1"," ..."},
{"op_task_dungeon_start_pr_1","There a chest in the dungeon "},
{"op_task_dungeon_start_po_1","near the location i marked for you,check your map ..."},
{"op_task_side","Side"},
{"op_task_main","Main"},
{"op_task_quest","Quest"},
{"op_task_start","Start"},
