...
namespace OdinPlus
{
	public class BuzzLocal
	{
		...
		private static Dictionary<string, string> english = new Dictionary<string, string>() {
			...
			{"odin_scroll_troll_name","Troll mead"},
			{"odin_scroll_troll_desc","This item will summon a pet"},
		...
		private static Dictionary<string, string> chinese = new Dictionary<string, string>() {
			...
			{"odin_scroll_troll_name","巨魔卷轴"},
			{"odin_scroll_troll_desc","地精的商品，据说可以召唤一只巨魔打工人，但是他不会打我吧..."},
